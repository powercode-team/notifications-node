...
import { IEntity, INotificationBaseRepository, IObject, IOptions } from '../../../interface';
import { PartialProps, PartialRequired } from '../../../type';
import { Filter, MemoryDriver } from '../memory.driver';

export abstract class MemoryBaseRepository<Entity extends IEntity<string>> implements INotificationBaseRepository<Entity, string> {
